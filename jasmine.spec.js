...
describe('simulatetouch.js', function() {
	...
	it('should trigger touchstart, touchmove and touchend events after swipe was called and set all supplied properties',function () {
		...
		expect(window.oResults.eventMove.touches[0].screenX).toBe((_aStart[0].screenX + _aEnd[0].screenX) / 2);
		expect(window.oResults.eventMove.touches[0].screenY).toBe((_aStart[0].screenY + _aEnd[0].screenY) / 2);
		expect(window.oResults.eventMove.touches[0].pageX).toBe((_aStart[0].pageX + _aEnd[0].pageX) / 2);
		expect(window.oResults.eventMove.touches[0].pageY).toBe((_aStart[0].pageY + _aEnd[0].pageY) / 2);
		expect(window.oResults.eventMove.touches[0].clientX).toBe(window.oResults.eventMove.touches[0].pageX);
		expect(window.oResults.eventMove.touches[0].clientY).toBe(window.oResults.eventMove.touches[0].pageY);
		...
		expect(window.oResults.eventMove.touches[1].screenX).toBe((_aStart[1].screenX + _aEnd[1].screenX) / 2);
		expect(window.oResults.eventMove.touches[1].screenY).toBe((_aStart[1].screenY + _aEnd[1].screenY) / 2);
		expect(window.oResults.eventMove.touches[1].pageX).toBe((_aStart[1].pageX + _aEnd[1].pageX) / 2);
		expect(window.oResults.eventMove.touches[1].pageY).toBe((_aStart[1].pageY + _aEnd[1].pageY) / 2);
